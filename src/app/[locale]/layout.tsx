...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "All Firing Wiki - Codes, Tier List & Beginner Guide",
    description:
      "All Firing Wiki covers codes, tier list, reroll targets, characters, team builds, launch events, beginner tips, exploration, and boss combat guides.",
    robots: {
      index: true,
      follow: true,
      googleBot: {
      ...
      images: [
        {
          ...
          width: 1920,
          height: 1080,
          alt: "All Firing - Anime Side-Scroller Action RPG",
        },
      ],
    },
    twitter: {
