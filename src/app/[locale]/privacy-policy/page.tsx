...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - All Firing Wiki',
    description: 'All Firing Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our iOS and Android game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              All Firing Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including iOS and Android, Discord, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              All Firing Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Valve Corporation (iOS and Android) or the developers of All Firing. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@allfiring.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@allfiring.wiki</a>
            </p>
            <p>
