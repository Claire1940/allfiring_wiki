...
export default function HomePageClient({
  ...
  const siteUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://www.allfiring.wiki";
    ...
    "@graph": [
      {
        ...
        "@id": `${siteUrl}/#website`,
        url: siteUrl,
        name: "All Firing Wiki",
        description:
          "Complete All Firing Wiki covering crafting, biomes, creatures, items, achievements, lore, and survival tips for the surreal voxel sandbox on Steam.",
        image: {
          "@type": "ImageObject",
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          caption: "All Firing - Surreal Voxel Survival Sandbox",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        name: "All Firing Wiki",
        alternateName: "All Firing",
        url: siteUrl,
        description:
          "Complete All Firing Wiki resource hub for crafting, biomes, creatures, items, achievements, and survival guides",
        logo: {
          "@type": "ImageObject",
        ...
        image: {
          ...
          width: 1920,
          height: 1080,
          caption: "All Firing Wiki - Surreal Voxel Survival Sandbox",
        },
        sameAs: [
          "https://allfiring.genmugame.com/",
          "https://discord.gg/Bps5JRkSgQ",
          "https://x.com/ALLfiring2026",
          "https://www.youtube.com/@ALLfiringOfficial",
        ],
      },
      {
        "@type": "VideoGame",
        ...
        genre: ["Action RPG", "Anime", "Side-Scroller", "Exploration"],
        numberOfPlayers: {
          minValue: 1,
          maxValue: 1,
        },
        offers: {
          ...
          url: "https://allfiring.genmugame.com/",
        },
      },
      {
        "@type": "VideoObject",
        name: "ALLfiring Official Trailer",
        description:
          "Official ALLfiring trailer featuring anime action combat, exploration, and team switching.",
        uploadDate: "2026-03-12",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/vYvdpE_X-eI",
        url: "https://www.youtube.com/watch?v=vYvdpE_X-eI",
      },
    ],
  };
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8 scroll-reveal">
            ...
            <div className="mb-10 flex flex-col justify-center gap-3 sm:flex-row md:mb-12 md:gap-4">
              ...
              <a
                href="https://allfiring.genmugame.com/"
                target="_blank"
      ...
      <section className="px-4 py-10 md:py-12">
        <div className="scroll-reveal container mx-auto max-w-4xl">
          <div className="relative overflow-hidden rounded-2xl">
            <VideoFeature
              videoId="vYvdpE_X-eI"
              title="ALLfiring Official Trailer"
            ...
            {t.modules.lucidBlocksCreaturesAndEnemies.creatures.map(
              (c: any, index: number) => (
                ...
                >
                  <div className="mb-3">
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${["Hostile Enemy", "Major Threat", "Elite Threat"].includes(c.role) ? "bg-[hsl(var(--nav-theme-light)/0.15)] border-[hsl(var(--nav-theme-light)/0.4)] text-[hsl(var(--nav-theme-light))]" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {c.role}
                    </span>
                  </div>
              ...
              (p: any, index: number) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${p.priority === "Essential" ? "bg-[hsl(var(--nav-theme-light)/0.15)] border-[hsl(var(--nav-theme-light)/0.4)] text-[hsl(var(--nav-theme-light))]" : p.priority === "Very High" ? "bg-[hsl(var(--nav-theme)/0.15)] border-[hsl(var(--nav-theme)/0.4)] text-[hsl(var(--nav-theme))]" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {p.priority}
                    </span>
                  </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://discord.gg/Bps5JRkSgQ"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://x.com/ALLfiring2026"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
                ...
                <li>
                  <a
                    href="https://www.facebook.com/profile.php?id=61585042701755"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
