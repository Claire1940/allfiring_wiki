...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - All Firing Wiki',
    description: 'Copyright and intellectual property information for All Firing Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - All Firing Wiki',
      description: 'Copyright and intellectual property information for All Firing Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 All Firing Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of All Firing Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              All Firing Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>iOS and Android</strong> - Owner of the iOS and Android platform</li>
              <li><strong>All Firing Developers</strong> - Creators of the All Firing game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>All Firing</strong> - Trademark of the game developers</li>
              <li><strong>All Firing Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with All Firing Wiki.
            </p>
            ...
            <p>
              ...
              All Firing Wiki<br />
              Email: <a href="mailto:dmca@allfiring.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@allfiring.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "All Firing Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: All Firing Wiki (allfiring.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@allfiring.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@allfiring.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@allfiring.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@allfiring.wiki</a>
            </p>
            <p>
