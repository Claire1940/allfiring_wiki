...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - All Firing Wiki",
    description: "Read the Terms of Service for All Firing Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our iOS and Android game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - All Firing Wiki",
      description: "Terms and conditions for using All Firing Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using All Firing Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using All Firing Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and All Firing Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              All Firing Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the iOS and Android game "All Firing". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> All Firing Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (iOS and Android) or the official developers of All Firing. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by All Firing Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (iOS and Android) and/or the developers of All Firing. We use such
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> iOS and Android demo availability and game updates may change without notice. We are not responsible for demo access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              The Website may contain links to third-party websites, including iOS and Android, Discord, social media platforms,
            ...
            <p>
              ...
              you and All Firing Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@allfiring.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@allfiring.wiki</a>
            </p>
            <p>
